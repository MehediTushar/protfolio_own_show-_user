                ...
                <div class="card-body">
                  ...
                  <form action="{{route('admin.protfolio.update',$protfolios->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="title" id="title" placeholder="Title" value="{{$protfolios->title}}">
                              </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="url" class="form-control" name="pro_link" id="pro_link" value="{{$protfolios->pro_link}}" placeholder="share link">
                          </div>
                </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <textarea class="form-control"  name="description" id="description" rows="5">{{$protfolios->description}}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <img style="height: 5vh" src="{{url($protfolios->big_img)}}" class="img-thumbnail">
