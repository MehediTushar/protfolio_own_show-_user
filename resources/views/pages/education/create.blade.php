    ...
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
                    ...
                    <form action="{{route('admin.edu.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="form-group row">
                                <label for="institute_dep">DepartMent</label>
                                <div class="col-sm-6">
                                <input type="text" class="form-control" name="institute_dep" id="institute_dep" placeholder="DepartMent/dis">
                            </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                <input type="text" class="form-control" name="gpa" id="gpa" placeholder="GPA/CGPA">
                            </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                <input type="date" class="form-control" name="paasing_year" id="paasing_year" placeholder="Passing Year">
                                </div>
                            </div>
