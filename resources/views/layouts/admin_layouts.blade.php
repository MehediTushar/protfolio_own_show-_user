...
<head>
  ...
  <title>Admin</title>
  <!-- base:css -->
  <link rel="stylesheet" href="{{ecure_asset('admin_secure_assets/vendors/typicons/typicons.css')}}">
  <link rel="stylesheet" href="{{secure_asset('admin_secure_assets/vendors/css/vendor.bundle.base.css')}}">
  <!-- endinject -->
  <!-- plugin css for this page -->
  <!-- End plugin css for this page -->
  <!-- inject:css -->
  <link rel="stylesheet" href="{{secure_asset('admin_secure_assets/css/vertical-layout-light/style.css')}}">
  <!-- endinject -->
  <link rel="shortcut icon" href="{{secure_asset('admin_secure_assets/images/t1.svg')}}" />
</head>
<body>
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
          <a class="navbar-brand brand-logo" href="{{route('admin.dashboard')}}"><img src="{{asset('admin_secure_assets/images/t2.svg')}}" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href="{{route('admin.dashboard')}}"><img src="{{asset('admin_secure_assets/images/t1.svg')}}" alt="logo"/></a>
