...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="{{asset('admin_assets/images/t1.svg')}}" />
</head>
<body>
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
          <a class="navbar-brand brand-logo" href="{{route('admin.dashboard')}}"><img src="{{asset('admin_assets/images/t2.svg')}}" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href="{{route('admin.dashboard')}}"><img src="{{asset('admin_assets/images/t1.svg')}}" alt="logo"/></a>
